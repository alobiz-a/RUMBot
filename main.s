...
extrn	display_on_LCD	; in LCD_show.s
extrn	LCD_Setup   ; in LCD_routines.s
extrn	UART_Setup, send_dists_UART  ; in UART_routines.s
extrn	time_H, time_L ; ranger measurement
extrn	Set_Mdelay_counter, M_loop_90R1, M_loop_45R1, M_loop_01, M_loop_45L1, M_loop_90L1 ; from servo_routines.s
extrn	Delay_3s    ; from delay.s
extrn	setup_DCmotor, vertical_motion	; from DC_motor.s
...
interrupt:
    ...
    goto    which_interrupt ;check if we're detecting the rising or falling edge
