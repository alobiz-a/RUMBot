...
global  UART_Setup, send_dists_UART
extrn	dist_H, dist_L


psect	udata_acs   ; reserve data space in access ram
UART_counter: ds    1	    ; reserve 1 byte for variable UART_counter
UART_hex_tmp:	ds 1    ; reserve 1 byte for variable UART_hex_tmp - A. CHANGE
UART_tmp:	ds 1	; reserve 1 byte for temporary use - A. CHANGE
...
UART_Transmit_Byte:	    ; Transmits byte stored in W
    ...
    movwf   TXREG1, A
    return
;******************DO I NEED THIS (RENAME)?***************************
; Same logic as for LCD
UART_Transmit_Hex:			; Writes byte stored in W as hex
